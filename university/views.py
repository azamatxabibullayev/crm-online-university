...
def admin_take_attendance_view(request, cl):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request, 'university/admin_take_attendance.html', {'students': students, 'aform': aform})
...
def admin_view_attendance_view(request, cl):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'university/admin_view_attendance_page.html',
...
def teacher_take_attendance_view(request, cl):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request, 'university/teacher_take_attendance.html', {'students': students, 'aform': aform})
...
def teacher_view_attendance_view(request, cl):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            studentdata = models.StudentExtra.objects.all().filter(cl=cl)
            mylist = zip(attendancedata, studentdata)
            return render(request, 'university/teacher_view_attendance_page.html',
                          {'cl': cl, 'mylist': mylist, 'date': date})
        else:
            print('form invalid')
    return render(request, 'university/teacher_view_attendance_ask_date.html', {'cl': cl, 'form': form})
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            attendancedata = models.Attendance.objects.all().filter(date=date, cl=studentdata[0].cl,
                                                                    roll=studentdata[0].roll)
            mylist = zip(attendancedata, studentdata)
            return render(request, 'university/student_view_attendance_page.html', {'mylist': mylist, 'date': date})
        else:
            print('form invalid')
    return render(request, 'university/student_view_attendance_ask_date.html', {'form': form})
