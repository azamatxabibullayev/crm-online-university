...
urlpatterns = [
    ...
    path('adminlogin', LoginView.as_view(template_name='university/adminlogin.html')),
    path('studentlogin', LoginView.as_view(template_name='university/studentlogin.html')),
    path('teacherlogin', LoginView.as_view(template_name='university/teacherlogin.html')),


    path('afterlogin', views.afterlogin_view,name='afterlogin'),
    path('logout', LogoutView.as_view(template_name='university/index.html'),name='logout'),
